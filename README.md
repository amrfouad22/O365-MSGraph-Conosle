...
* A client ID of an application registered in Azure. Use the appropirate permissions for the **Microsoft Graph** application so you can test the MS Graph console. [Add a web application in Azure](https://msdn.microsoft.com/office/office365/HowTo/add-common-consent-manually#bk_RegisterWebApp) and [grant the proper permissions](https://github.com/OfficeDev/O365-Angular-Microsoft-Graph-Connect/wiki/Grant-permissions-to-the-Connect-application-in-Azure) to it.
...
1. Using the UI you can update the Client ID value which reference your Azure AD app
